...
import com.lok.command.FileUploadCommand;

@Controller
public class ContentUpload {

	@RequestMapping(value="register.do",method=RequestMethod.GET)
	public String showForm(@ModelAttribute("regCmd")FileUploadCommand cmd){
	...
	public String processForm(Map<String,Object> map,@ModelAttribute("regCmd")FileUploadCommand cmd)throws Exception{
